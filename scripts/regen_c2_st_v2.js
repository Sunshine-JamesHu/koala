...
for (const groupName of ['S01', 'S02', 'S03', 'S04']) {
    ...
    out.push(> 提示：下面这一整段要用说书人的沉浸式第三人称视角，配合画面讲故事。句首的数字代表此时画面**正好切到对应序号的分镜图**。);
    out.push("");
