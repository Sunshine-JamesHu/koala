...
description: 专业的情绪分析师，负责分析故事中的情感走向，为配乐、运镜、色彩等提供情绪参考依据。
---
...
```json
{
  ...
  "emotion_timeline": [
    {
      ...
      "text_position": { "start": 0, "end": 500 },
      "emotions": {
        "primary": { "type": "anticipation", "intensity": 0.6 },
        "secondary": { "type": "anxiety", "intensity": 0.4 }
      },
  ...
  "emotion_peaks": [
    { "position": 0.3, "type": "tension_build", "intensity": 0.8, "description": "穿越认知的冲击", "resolution": "后续探索" },
    { "position": 0.7, "type": "climax", "intensity": 0.9, "description": "发现重要真相", "resolution": "悬念设置" }
  ],
  "emotion_transitions": [
    { "from": "confusion", "to": "determination", "position": 0.5, "trigger_event": "evt_003", "transition_type": "gradual|sudden" }
  ],
  "character_emotions": {
    "辛月影": {
